    ...
    var t = {
                ...
                var n = e(9974),
                    ...
                    f = function (t) {
                        ...
                        return function (h, d, y, m) {
                            for (var g, b, x = a(h), w = i(x), S = n(d, y), j = u(w), O = 0, E = m || c, T = r ? E(h, j) : e || v ? E(h, 0) : void 0; j > O; O++)
            ...
            5948: (t, r, e) => {
                ...
                O || (n = function () {
                    ...
                    i = void 0, t && t.enter()
                }, d || g || m || !b || !x ? !y && S && S.resolve ? ((s = S.resolve(void 0)).constructor = S, f = v(s.then, s), a = function () {
                    f(n)
                }) : g ? a = function () {
                    w.nextTick(n)
                } : (h = v(h, p), a = function () {
            ...
            9191: (t, r, e) => {
                ...
                t.exports = function (t, r, e, d) {
                    ...
                    if (b) {
                        ...
                        if (S.prototype = x, "Error" !== g && (u ? u(S, w) : c(S, w, {
                                name: !0
                            })), c(S, b), !h) try {
            ...
            8862: (t, r, e) => {
                var n = e(2109),
                    ...
                    b = function (t, r, e) {
                        var n = v(e, r - 1),
                            o = v(e, r + 1);
                        return p(m, t) && !p(g, o) || p(g, t) && !p(m, n) ? "\\u" + d(l(t, 0), 16) : t
                    },
                    x = c((function () {
                        return '"\\udf06\\ud834"' !== f("\udf06\ud834") || '"\\udead"' !== f("\udead")
                    }));
            ...
            8674: (t, r, e) => {
                ...
                if (et && (B = (W = function (t) {
                        ...
                        then: function (t, r) {
                            var e = H(this),
                                n = X(E(this, W));
                            return e.parent = !0, n.ok = !b(t) || t, n.fail = b(r) && r, n.domain = C ? $.domain : void 0, 0 == e.state ? e.reactions.add(n) : P((function () {
                                it(n, e)
                            })), n.promise
                        },
                        catch: function (t) {
    ...
    (() => {
        ...
        var u = a((function t(r) {
            ...
            f = function (r, e, n, i) {
                ...
                return s.append("lib_version", "3.5.0"), s.append("service_id", r), s.append("template_id", e), s.append("user_id", a), c("/api/v1.0/email/send-form", s)
            };
        const p = {
            init: r,
            send: s,
